...
export const crmData: TablePayload = {
    ...
    rows: [
        ...
        {
            name: "Noah Berg",
            company: "Alpine Supply",
            email: "noah@alpinesupply.net",
            stage: "Lead",
            owner: "Dana Kim",
            value: 18500,
        },
        {
            name: "Mia Laurent",
            company: "Cascade Works",
            email: "mia@cascadeworks.io",
            stage: "Qualified",
            owner: "Marcus Chen",
            value: 63000,
        },
        {
            ...
            email: "ethan@vertexrobotics.com",
            stage: "Closed won",
            owner: "Dana Kim",
            value: 210000,
        },
        {
            name: "Zara Haddad",
            company: "Pavilion Group",
            email: "zara@paviliongroup.co",
            stage: "Lead",
            owner: "Priya Shah",
            value: 9200,
        },
