...
# FIN-AUT-004 (SKY-85): budgets, depreciation, expense policy, compliance.
FINANCE_BUDGET_CREATED = "finance.budget.created"
FINANCE_BUDGET_UPDATED = "finance.budget.updated"
FINANCE_BUDGET_ACTIVATED = "finance.budget.activated"
FINANCE_BUDGET_CLOSED = "finance.budget.closed"
...
FINANCE_EXPENSE_POLICY_CREATED = "finance.expense_policy.created"
FINANCE_EXPENSE_POLICY_UPDATED = "finance.expense_policy.updated"
FINANCE_EXPENSE_CLAIM_SUBMITTED = "finance.expense_claim.submitted"
FINANCE_EXPENSE_CLAIM_APPROVED = "finance.expense_claim.approved"
FINANCE_EXPENSE_CLAIM_REJECTED = "finance.expense_claim.rejected"
FINANCE_EXPENSE_VIOLATION_RECORDED = "finance.expense.violation.recorded"
FINANCE_COMPLIANCE_ITEM_CREATED = "finance.compliance_item.created"
FINANCE_COMPLIANCE_ITEM_UPDATED = "finance.compliance_item.updated"
FINANCE_COMPLIANCE_ITEM_COMPLETED = "finance.compliance_item.completed"
