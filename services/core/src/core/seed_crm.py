...
_CONTACT_ROWS: tuple[dict[str, object], ...] = (
    {"customer": 0, "first": "Oliver", "last": "Hartley", "email": "oliver.hartley@commonwealthglass.co.uk", "phone": "+44 121 555 0193", "title": "Procurement Director", "primary": True},
    {"customer": 0, "first": "Amelia", "last": "Stone", "email": "amelia.stone@commonwealthglass.co.uk", "phone": "+44 121 555 0194", "title": "Finance Lead", "primary": False},
    {"customer": 1, "first": "Caleb", "last": "Mercer", "email": "caleb.mercer@alderdistributors.com", "phone": "+1 206 555 0115", "title": "Operations Manager", "primary": True},
    {"customer": 2, "first": "Grace", "last": "Lindqvist", "email": "grace.lindqvist@redpine.com", "phone": "+1 303 555 0186", "title": "VP Sales", "primary": True},
    {"customer": 3, "first": "Nolan", "last": "Fisher", "email": "nolan.fisher@veridianfoods.com", "phone": "+1 212 555 0139", "title": "Head of Procurement", "primary": True},
    {"customer": 4, "first": "Eva", "last": "Brandt", "email": "eva.brandt@summit-outfitters.de", "phone": "+49 40 555 0121", "title": "Chief Operating Officer", "primary": True},
    {"customer": 5, "first": "Theo", "last": "Barnes", "email": "theo.barnes@oakhill.health", "phone": "+1 615 555 0148", "title": "IT Director", "primary": True},
    {"customer": 6, "first": "Iris", "last": "Chambers", "email": "iris.chambers@granitebaytech.com", "phone": "+1 408 555 0165", "title": "Head of Engineering", "primary": True},
    {"customer": 7, "first": "Milo", "last": "Granger", "email": "milo.granger@lakeshoreelec.com", "phone": "+1 312 555 0178", "title": "Purchasing Lead", "primary": True},
    {"customer": 8, "first": "Aisha", "last": "Tan", "email": "aisha.tan@pinnaclegroup.sg", "phone": "+65 6555 0123", "title": "Finance Manager", "primary": True},
    {"customer": 9, "first": "Henry", "last": "Windsor", "email": "henry.windsor@willowandsage.ca", "phone": "+1 416 555 0157", "title": "Founder", "primary": True},
    {"customer": 3, "first": "Ruby", "last": "Delgado", "email": "ruby.delgado@veridianfoods.com", "phone": "+1 212 555 0168", "title": "Category Manager", "primary": False},
    {"customer": 5, "first": "Jack", "last": "O'Connell", "email": "jack.oconnell@oakhill.health", "phone": "+1 615 555 0172", "title": "Facilities Lead", "primary": False},
    {"customer": 2, "first": "Freya", "last": "Ashworth", "email": "freya.ashworth@redpine.com", "phone": "+1 303 555 0199", "title": "Project Coordinator", "primary": False},
)

_ACTIVITY_ROWS: tuple[dict[str, object], ...] = (
    {"kind": ActivityKind.FOLLOW_UP, "anchor": ("lead", 0), "subject": "Demo call with Brightline", "description": "Walked through the product; they want a pricing sheet.", "due_days": 1, "completed": False},
    {"kind": ActivityKind.CALL, "anchor": ("lead", 1), "subject": "Intro call — Kronfeld Bau", "description": "Discussed warehouse footprint and integration needs.", "due_days": -1, "completed": True},
    {"kind": ActivityKind.EMAIL, "anchor": ("lead", 2), "subject": "Sent follow-up deck", "description": "Shared the logistics solution deck.", "due_days": -2, "completed": True},
    {"kind": ActivityKind.TASK, "anchor": ("lead", 3), "subject": "Prepare proposal draft", "description": "Draft the scope for Mangrove Tech.", "due_days": 3, "completed": False},
    {"kind": ActivityKind.MEETING, "anchor": ("lead", 4), "subject": "Discovery workshop", "description": "Requirements gathering for Atlantica.", "due_days": 5, "completed": False},
    {"kind": ActivityKind.TASK, "anchor": ("lead", 11), "subject": "Send NDA for Alpen Logistics", "due_days": 2, "completed": False},
    {"kind": ActivityKind.CALL, "anchor": ("opportunity", 0), "subject": "Quarterly review — Cedar Peak", "description": "Confirmed budget line for the gear refresh.", "due_days": -3, "completed": True},
    {"kind": ActivityKind.FOLLOW_UP, "anchor": ("opportunity", 0), "subject": "Send revised contract", "due_days": 4, "completed": False},
    {"kind": ActivityKind.MEETING, "anchor": ("opportunity", 1), "subject": "Negotiation session — Forma Group", "description": "Aligning on rollout timeline and support terms.", "due_days": 2, "completed": False},
    {"kind": ActivityKind.EMAIL, "anchor": ("opportunity", 1), "subject": "Proposal v3 sent", "description": "Included volume discount and onboarding plan.", "due_days": -4, "completed": True},
    {"kind": ActivityKind.TASK, "anchor": ("opportunity", 2), "subject": "Qualify Vesper Systems scope", "due_days": 7, "completed": False},
    {"kind": ActivityKind.CALL, "anchor": ("opportunity", 4), "subject": "Solution demo — Ironclad", "description": "Safety compliance walkthrough.", "due_days": -2, "completed": True},
    {"kind": ActivityKind.FOLLOW_UP, "anchor": ("opportunity", 5), "subject": "Answer Sagehill pricing questions", "due_days": 1, "completed": False},
    {"kind": ActivityKind.MEETING, "anchor": ("opportunity", 6), "subject": "Quicksilver security review", "due_days": 6, "completed": False},
    {"kind": ActivityKind.EMAIL, "anchor": ("opportunity", 7), "subject": "Zephyr — commercial terms sent", "due_days": -1, "completed": True},
    {"kind": ActivityKind.CALL, "anchor": ("opportunity", 11), "subject": "Discovery — Harbor & Fenwick", "description": "Legal document AI scope call.", "due_days": 3, "completed": False},
    {"kind": ActivityKind.FOLLOW_UP, "anchor": ("customer", 0), "subject": "Quarterly business review", "description": "Reviewing satisfaction and roadmap.", "due_days": -5, "completed": True},
    {"kind": ActivityKind.EMAIL, "anchor": ("customer", 0), "subject": "Sent renewal notice", "due_days": 10, "completed": False},
    {"kind": ActivityKind.CALL, "anchor": ("customer", 1), "subject": "Support call — Alder", "description": "Helped with the export template issue.", "due_days": -1, "completed": True},
    {"kind": ActivityKind.TASK, "anchor": ("customer", 2), "subject": "Upload Redpine asset list", "due_days": 2, "completed": False},
    {"kind": ActivityKind.MEETING, "anchor": ("customer", 5), "subject": "Oakhill training session", "description": "Train new staff on the system.", "due_days": 8, "completed": False},
    {"kind": ActivityKind.FOLLOW_UP, "anchor": ("customer", 7), "subject": "Chase Lakeshore payment", "due_days": 0, "completed": False},
    {"kind": ActivityKind.EMAIL, "anchor": ("contact", 4), "subject": "Veridian — onboarding email", "due_days": -1, "completed": True},
    {"kind": ActivityKind.CALL, "anchor": ("customer", 9), "subject": "Welcome call — Willow & Sage", "description": "Walked through first steps.", "due_days": -1, "completed": True},
)

_NOTE_ROWS: tuple[dict[str, object], ...] = (
    {"anchor": ("lead", 0), "body": "Maya mentioned they evaluate two vendors each year. Keep the pricing sheet concise."},
    {"anchor": ("lead", 2), "body": "Prefers email over phone. Local timezone UTC+5:30."},
    {"anchor": ("lead", 7), "body": "Referred by Veridian Foods. Strong fit for the outdoor retail segment."},
    {"anchor": ("opportunity", 0), "body": "Champion is Hannah at Cedar Peak — keeps the budget line visible internally."},
    {"anchor": ("opportunity", 1), "body": "Forma is comparing with a local competitor; our onboarding speed is the differentiator."},
    {"anchor": ("opportunity", 5), "body": "Sagehill needs a SOC 2 appendix in the proposal. Ask security to draft it."},
    {"anchor": ("opportunity", 6), "body": "Quicksilver procurement cycle takes ~30 days after sign-off."},
    {"anchor": ("customer", 0), "body": "Renewal due in the next quarter. Finance contact is Amelia Stone."},
    {"anchor": ("customer", 1), "body": "Sensitive to price changes — grandfather rates if possible."},
    {"anchor": ("customer", 5), "body": "Expanding to two new clinics next year; plan for extra seats."},
    {"anchor": ("customer", 9), "body": "New account — prefer weekly check-ins during the first month."},
