"""Generic finite state machine for identity domain lifecycles.
...
hops (e.g. suspended -> invited) fail fast instead of silently corrupting
state. Used by the membership lifecycle today and by the auth pipeline
(onboarding, email-verification, MFA) as those flows land.
"""
